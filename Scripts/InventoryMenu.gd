...
@onready var platinum_label := $Panel/VBox/PlatinumLabel
...
@onready var platinum_price_label = $Panel/VBox/HBox/VBoxContainer/PlatinumPriceLabel
...
func _refresh(_new_credits: int = 0) -> void:
	...
	platinum_label.text = "Platinum: %d" % GameState.minerals[GameState.MineralType.PLATINUM]
...
func _price_refresh():
	...
	platinum_price_label.text = "Platinum: $%d" % GameState.market_prices[GameState.MineralType.PLATINUM]
