...
func _ready() -> void:
	...
	print("Asteroid created with ", hit_points, " HP")
...
func hit_by_projectile(_p: Node) -> void:
	hit_points -= 1
	print("Asteroid hit! Remaining HP: ", hit_points)
...
func _break_safe() -> void:
	...
	print("Breaking asteroid - spawning ", mineral_drop_count, " minerals")
	...
	if child_scene and radius > 10.0:
		print("Splitting into 2 child asteroids")
		for i in 2:
		...
		print("No child scene or radius too small - not splitting")
